    ...
    public static partial class LahkesisExtensions
    {
            ...
            where TType : struct
        {
            ...
            return Type.GetTypeCode(typeof(TType)) switch
            {
                ...
                TypeCode.String => (TType)(object)random.NextDecimal(decimal.Parse((string)(object)minValue), decimal.Parse((string)(object)maxValue)).ToString(CultureInfo.InvariantCulture),
                _ => throw new InvalidOperationException(Error.Message.NextTInvalidType),
            };
        }
    }
