...
public static partial class LahkesisExtensions
{
    ...
    [Obsolete("Use native Random.NextInt64(long, long) instead.", false)]
#endif
    [PublicAPI]
...
#endif
#if NET6_0_OR_GREATER
    [Obsolete("Use native Random.NextInt64(long) instead.", false)]
#endif
    [PublicAPI]
    [NonNegativeValue]
    public static long NextInt64(
        this Random random,
        [ValueRange(0, long.MaxValue)] long maxValue)
    {
        Error.ThrowIfArgumentNull(random, nameof(random));
        if (maxValue == 0L)
        {
...
#endif
#if NET6_0_OR_GREATER
    [Obsolete("Use native Random.NextInt64() instead.", false)]
#endif
    [PublicAPI]
    [NonNegativeValue]
    public static long NextInt64(
    ...
    internal static long GenerateInt64Internal(Random random)
    {
        ...
        } while (result is long.MinValue or long.MaxValue);

        return result < 0L ? result + long.MaxValue : result;
    }
